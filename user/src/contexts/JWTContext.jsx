...
export const JWTProvider = ({ children }) => {
  ...
  const login = async (email, password, device_token) => {
    const response = await axios.post('/user/login', { email, password, device_token });
    const { result: user } = response.data;
  ...
  const register = async (refer_id, firstName, lastName, identifier, password, phone_number, device_token) => {

    ...
    <>
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          device_token: Yup.string().required('Android id  is required'),
          password: Yup.string()
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            ...
            await register(refer_id, values.firstname, values.lastname, values.email, values.password, values.phone_number, values.device_token)
              .then(() => {
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  ...
                  {touched.password && errors.password && (
                   ...
                   {device_token=='45545gg'?'Static token is working':'dynamic not working'}{device_token}
